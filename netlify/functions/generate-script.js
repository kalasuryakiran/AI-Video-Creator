...
// netlify/functions/generate-script.ts
var generate_script_exports = {};
__export(generate_script_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(generate_script_exports);
...
// shared/schema.ts
var videoScripts = pgTable("video_scripts", {
...
var insertVideoScriptSchema = createInsertSchema(videoScripts).omit({
  id: true,
  createdAt: true
});
var generateScriptRequestSchema = z.object({
...
async function generateVideoScript(request) {
  try {
